...
import Activity_Edit from './pages/Activity/Activity_Home';
import Activity_Registration from './pages/Activity/Activity_registration';
...
{/* <Route path="/table" element={<ProductTable></ProductTable>}></Route> */}
        ...
        <Route path="/edit/:id" element={<Activity_Edit/>}></Route>
        <Route path="/edit/:id" element={<Activity_table/>}></Route>
        <Route path="/edit/:id" element={<Activity_registration/>}></Route>
